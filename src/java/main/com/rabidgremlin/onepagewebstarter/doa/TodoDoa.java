...
public class TodoDoa
{
  ...
  public TodoDoa()
  {
	todos.add(new TodoDto(UUID.randomUUID().toString(), "Buy some milk", false, new DateTime().minusMinutes(10)));
	todos.add(new TodoDto(UUID.randomUUID().toString(), "Pick up dry cleaning", false, new DateTime().minusMinutes(12)));
	todos.add(new TodoDto(UUID.randomUUID().toString(), "Put out trash", true, new DateTime().minusMinutes(13)));
  }
